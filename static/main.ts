...
async function setup() {
    ...
    async function setupShaders(vertexResource, fragmentResource): Promise<WebGLProgram> {
    ...
    let territories: Array<APITerritory> = Object.values(terdat.territories);
    ...
    let terrVertices = territories.map((t: APITerritory) => {
